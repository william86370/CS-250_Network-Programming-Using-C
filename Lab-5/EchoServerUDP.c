...
{
    printf("|------------------------------------------------------------------------------------------|\n");
    printf("|                                CS-250 Project-1 UDP-Server                               |\n");
    printf("|                                Developed By William Wright                               |\n");
    printf("|                  When Launched The Server will lisien on port 5000                       |\n");
    printf("|------------------------------------------------------------------------------------------|\n");
    ...
    /* ------Step 3 recieve from the socket  ------- */
        ...
        if ((rcvMsgSize = recvfrom(genSock_d, echoBuffer, ECHOMAX, 0,
            ...
            DieWithError("recvfrom() failed");//we dont need this but it is nice to have to handle errors

        printf("Recieved UDP Request From: %s\n", inet_ntoa(echoClntAddr.sin_addr));
